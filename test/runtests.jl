...
import MatrixCorrectionTools: correction!, correction
...
@testset "MatrixCorrectionTools.jl" begin
    ...
    @test correction!(CustomStrategyAddsOne(), deepcopy(A)) == (A .+ 1)

    # Test inplace version
    copyA = deepcopy(A)
    @test correction!(CustomStrategyAddsOne(), copyA) === copyA
